...
void cat(int fd)
{
  ...
  24:	564080e7          	jalr	1380(ra) # 584 <read>
  28:	84aa                	mv	s1,a0
  ...
  38:	558080e7          	jalr	1368(ra) # 58c <write>
  3c:	fc950ee3          	beq	a0,s1,18 <cat+0x18>
        {
            fprintf(2, "cat: write error\n");
  40:	00001597          	auipc	a1,0x1
  44:	a6058593          	addi	a1,a1,-1440 # aa0 <malloc+0xea>
  48:	4509                	li	a0,2
  4a:	00001097          	auipc	ra,0x1
  4e:	886080e7          	jalr	-1914(ra) # 8d0 <fprintf>
            exit(1);
  52:	4505                	li	a0,1
  54:	00000097          	auipc	ra,0x0
  58:	518080e7          	jalr	1304(ra) # 56c <exit>
        }
    }
    if (n < 0)
  ...
  72:	a4a58593          	addi	a1,a1,-1462 # ab8 <malloc+0x102>
  76:	4509                	li	a0,2
  78:	00001097          	auipc	ra,0x1
  7c:	858080e7          	jalr	-1960(ra) # 8d0 <fprintf>
        exit(1);
  80:	4505                	li	a0,1
  82:	00000097          	auipc	ra,0x0
  86:	4ea080e7          	jalr	1258(ra) # 56c <exit>
...
int main(int argc, char *argv[])
{
  ...
  be:	4f2080e7          	jalr	1266(ra) # 5ac <open>
  c2:	84aa                	mv	s1,a0
  ...
  d6:	4c2080e7          	jalr	1218(ra) # 594 <close>
    for (i = 1; i < argc; i++)
  ...
  fa:	476080e7          	jalr	1142(ra) # 56c <exit>
            fprintf(2, "cat: cannot open %s\n", argv[i]);
  fe:	00093603          	ld	a2,0(s2)
 102:	00001597          	auipc	a1,0x1
 106:	9ce58593          	addi	a1,a1,-1586 # ad0 <malloc+0x11a>
 10a:	4509                	li	a0,2
 10c:	00000097          	auipc	ra,0x0
 110:	7c4080e7          	jalr	1988(ra) # 8d0 <fprintf>
            exit(1);
 114:	4505                	li	a0,1
...
void acquire(struct lock *lk)
{
 ...
 19e:	94e50513          	addi	a0,a0,-1714 # ae8 <malloc+0x132>
...
void release(struct lock *lk)
{
 ...
 228:	8ec50513          	addi	a0,a0,-1812 # b10 <malloc+0x15a>
...
void _main(int argc, char *argv[])
{
 ...
 2f4:	d9a080e7          	jalr	-614(ra) # 8a <main>
    exit(res);
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66c:	53050513          	addi	a0,a0,1328 # b98 <digits>
 670:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	418c8c93          	addi	s9,s9,1048 # b40 <malloc+0x18a>
 ...
 73a:	462b8b93          	addi	s7,s7,1122 # b98 <digits>
 ...
 860:	2dc98993          	addi	s3,s3,732 # b38 <malloc+0x182>
        while(*s != 0){
 864:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 a12:	80278793          	addi	a5,a5,-2046 # 1210 <base>
